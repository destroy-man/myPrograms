package com.korobeynikov.p0641alertdialogitemsmulti
...
class MainActivity : AppCompatActivity() {
    ...
    protected override fun onCreateDialog(id:Int):Dialog{
        ...
        when(id){
            DIALOG_ITEMS->{
                ...
                adb.setMultiChoiceItems(data,chkd.toBooleanArray(),myItemsMultiClickListener)
            }
            DIALOG_CURSOR->{
    ...
    val myItemsMultiClickListener=DialogInterface.OnMultiChoiceClickListener{dialog,which,isChecked->
        Log.d(LOG_TAG,"which = "+which+", isChecked = "+isChecked)
    }

    val myCursorMultiClickListener=DialogInterface.OnMultiChoiceClickListener{dialog,which,isChecked->
