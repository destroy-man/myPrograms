...
class OpenGLRenderer(private val context: Context) : GLSurfaceView.Renderer {
    ...
    private fun prepareData() {
        val vertices = floatArrayOf(-1f, 1f, 1f,
                                    1f, 1f, 1f,
                                    -1f, -1f, 1f,
                                    1f, -1f, 1f,
                                    -1f, 1f, -1f,
        ...
        texture = TextureUtils.loadTextureCube(context, intArrayOf(R.drawable.box0,
            R.drawable.box1, R.drawable.box2, R.drawable.box3, R.drawable.box4, R.drawable.box5))
    }
