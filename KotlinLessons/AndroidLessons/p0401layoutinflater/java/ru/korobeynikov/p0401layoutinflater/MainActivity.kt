...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(LOG_TAG,"Class of view1: "+view1::class)
        Log.d(LOG_TAG,"Class of layoutParams of view1: "+lp1::class)
        val view2=ltInflater.inflate(R.layout.text,relLayout,true)
        val lp2=view2.layoutParams
        Log.d(LOG_TAG,"Class of view2: "+view2::class)
        Log.d(LOG_TAG,"Class of layoutParams of view2: "+lp2::class)
    }
}