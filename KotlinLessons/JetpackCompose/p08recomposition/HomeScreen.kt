...
@Composable
fun HomeScreenRecompositionChangeParameters(counter: State<Int>, onCounterClick: () -> Unit) {
    Log.d(TAG, "HomeScreen")
    ClickCounterRecompositionChangeParameters(counter = counter, onCounterClick = onCounterClick)
}

@Composable
fun ClickCounterRecompositionChangeParameters(counter: State<Int>, onCounterClick: () -> Unit) {
    val counterValue = counter.value
    Log.d(TAG, "ClickCounter $counterValue")
    Text(text = "Clicks: $counterValue", modifier = Modifier.clickable {
        Log.d(TAG, "--- click ---")
