...
@Composable
fun HomeScreen() {
    //MyColumn compact size with 150 dp
    MyColumn(
        modifier = Modifier
            .height(150.dp)
...
fun HomeScreenCompact() {
    MyColumnCompactSize(modifier = Modifier.background(Color.Gray)) {
        Text(text = "Text 1")
        Text(text = "Text 2")
        Text(text = "Text 3")
        Text(text = "Text 4")
...
@Composable
fun MyColumnCompactSize(modifier: Modifier = Modifier, content: @Composable () -> Unit) {
    Layout(modifier = modifier, content = content) { measurables, constraints ->
        val placeables = measurables.map { measurable ->
...
@Composable
fun MyColumnMaxSize(modifier: Modifier = Modifier, content: @Composable () -> Unit) {
    Layout(modifier = modifier, content = content) { measurables, constraints ->
        val placeables = measurables.map { measurable ->
